GOVUKPublishingFrontend.ButtonMenu = function(params) {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.onDocumentClick = function(e) {
	if(!$.contains(this.container[0], e.target)) {
	  this.hideMenu();
  }
};

GOVUKPublishingFrontend.ButtonMenu.prototype.createToggleButton = function() {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.setupResponsiveChecks = function() {
	this.mql = window.matchMedia(this.mq);
	this.mql.addListener($.proxy(this, 'checkMode'));
	this.checkMode(this.mql);
};

GOVUKPublishingFrontend.ButtonMenu.prototype.checkMode = function(mql) {
	if(mql.matches) {
		this.enableBigMode();
	} else {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.enableSmallMode = function() {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.enableBigMode = function() {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.removeButtonClasses = function() {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.addButtonClasses = function() {
	this.menu.find('.moj-button-menu__item').each(function(index, el) {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.hideMenu = function() {
	this.menuButton.attr('aria-expanded', 'false');
};

GOVUKPublishingFrontend.ButtonMenu.prototype.showMenu = function() {
	this.menuButton.attr('aria-expanded', 'true');
};

GOVUKPublishingFrontend.ButtonMenu.prototype.onMenuButtonClick = function() {
	this.toggle();
};

GOVUKPublishingFrontend.ButtonMenu.prototype.toggle = function() {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.onMenuKeyDown = function(e) {
	switch (e.keyCode) {
		case this.keys.down:
			this.toggle();
			break;
...
GOVUKPublishingFrontend.ButtonMenu.prototype.onButtonKeydown = function(e) {
	switch (e.keyCode) {
		case this.keys.up:
			e.preventDefault();
...
GOVUKPublishingFrontend.ButtonMenu.prototype.focusNext = function(currentButton) {
...
GOVUKPublishingFrontend.ButtonMenu.prototype.focusPrevious = function(currentButton) {
